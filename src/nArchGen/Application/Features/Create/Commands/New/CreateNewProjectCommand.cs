    ...
    public class CreateNewProjectCommandHandler : IStreamRequestHandler<CreateNewProjectCommand, CreatedNewProjectResponse>
    {
        ...
        private async Task removeSecurityMechanism(string projectName)
        {
            ...
            string[] dirsToDelete = new[]
            {
                ...
                $"{projectSourcePath}/Application/Features/SecurityClaims",
                $"{projectSourcePath}/Application/Features/UserSecurityClaims",
                ...
                $"{projectSourcePath}/Application/Services/SecurityClaims",
                $"{projectSourcePath}/Application/Services/UserSecurityClaims",
            ...
            string[] filesToDelete = new[]
            {
                ...
                $"{projectSourcePath}/Application/Services/Repositories/ISecurityClaimRepository.cs",
                ...
                $"{projectSourcePath}/Application/Services/Repositories/IUserSecurityClaimRepository.cs",
                ...
                $"{projectSourcePath}/Persistence/EntityConfigurations/SecurityClaimConfiguration.cs",
                ...
                $"{projectSourcePath}/Persistence/EntityConfigurations/UserSecurityClaimConfiguration.cs",
                $"{projectSourcePath}/Persistence/Repositories/EmailAuthenticatorRepository.cs",
                $"{projectSourcePath}/Persistence/Repositories/SecurityClaimRepository.cs",
                ...
                $"{projectSourcePath}/Persistence/Repositories/UserSecurityClaimRepository.cs",
                $"{projectSourcePath}/Persistence/Repositories/UserRepository.cs",
                $"{projectSourcePath}/WebAPI/Controllers/AuthController.cs",
                $"{projectSourcePath}/WebAPI/Controllers/SecurityClaimsController.cs",
                $"{projectSourcePath}/WebAPI/Controllers/UserSecurityClaimsController.cs",
                ...
                $"{projectTestsPath}/{projectName.ToPascalCase()}.Application.Tests/Mocks/FakeDatas/SecurityClaimFakeData.cs",
                ...
                predicate: line =>
                    (
                        new[]
                        {
                            ...
                            "DbSet<SecurityClaim> SecurityClaim",
                            "DbSet<OtpAuthenticator> OtpAuthenticator",
                            "DbSet<RefreshToken> RefreshTokens",
                            "DbSet<User> User",
                            "DbSet<UserSecurityClaim> UserSecurityClaims",
                        }
                    ).Any(line.Contains)
            );
            await FileHelper.RemoveLinesAsync(
