    ...
    public class CreateNewProjectCommandHandler : IStreamRequestHandler<CreateNewProjectCommand, CreatedNewProjectResponse>
    {
        ...
        private async Task removeSecurityMechanism(string projectName)
        {
            ...
            string[] dirsToDelete = new[]
            {
                ...
                $"{projectSourcePath}/Application/Features/UserClaims",
                ...
                $"{projectSourcePath}/Application/Services/UserClaims",
            ...
            string[] filesToDelete = new[]
            {
                ...
                $"{projectSourcePath}/Application/Services/Repositories/IUserClaimRepository.cs",
                ...
                $"{projectSourcePath}/Persistence/EntityConfigurations/UserClaimConfiguration.cs",
                ...
                $"{projectSourcePath}/Persistence/Repositories/UserClaimRepository.cs",
                ...
                $"{projectSourcePath}/WebAPI/Controllers/UserClaimsController.cs",
